  ...
  return <div className="modalBackground">
    <div className="modalContainer">
      ...
      <div className="bodytitle">
        <p className="titleProfile">Đặng Nguyễn Anh Tú</p>
        <p className="titleProfile">MSSV: 4501104265</p>
        <p className="titleProfile">Khoa: Công Nghệ Thông Tin</p>
      </div>
      <div class="iconsocial">
        <ul>
          <a href="https://www.facebook.com/dangnguyen.anhtu.9/" class="fa fa-facebook" target="_blank"></a>
